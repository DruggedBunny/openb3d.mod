...
Type TEntity
	...
	' applies Newton Dynamics matrix to B3D entity (thanks, Kryzon!)
	Method MQ_ApplyNewtonTransform( newtonMatrix:Float Ptr )
		
		MQ_ApplyNewtonTransform_( GetInstance(Self),newtonMatrix )
